      ...
      <div className="row">
        ...
        <div class="col-md-6 d-flex flex-column p-3 m-3 bg-white shorten-card shadow-sm rounded animated flipInX delay-8">
          ...
          <div>
            ...
            <small><i class="fas fa-file-signature"></i></small> Case Name:<small>&nbsp;&nbsp;{caseDetail?.name}</small>
            </h5>
          </div>
          <div>
            <h5 class="mx-1  pb-3 justify-content-start">
           <small> <i class="far fa-id-badge pr-1"></i></small>LegacyID:<small>&nbsp;&nbsp;{caseDetail?.legacy_id}</small>
            </h5>
          </div>
          <div>
            <h5 class="mx-1  pb-3 justify-content-start">
            <small><i class="far fa-clock pr-1"></i></small>Expiry Date:<small>&nbsp;&nbsp;{caseDetail?.expiring_date}</small>
            </h5>
          </div>
          <div>
            <h5 class="mx-1  pb-3 justify-content-start">
            <small><i class="fas fa-question pr-1"></i> </small>Status:<small>&nbsp;&nbsp;{caseDetail?.legacy_id}</small>
            </h5>
            <input
              type="button"
              class="modal-buttons"
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-footer">
                    ...
                    <button onClick={()=>setCurrent(values)} type="submit">Update Case</button>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="col-md-5 d-flex flex-column p-3 m-3 bg-white shorten-card shadow-sm rounded animated flipInX delay-8">
          ...
          <div>
            <h5 class="mx-1  pb-3 justify-content-start">
             <small><i class="fas fa-dot-circle text-sm"></i></small> Number Of Assets:<small>{caseDetail?.name}</small>
            </h5>
            {/* <i class="fab fa-xs fa-google pr-1"></i>  */}
          </div>
          <div>
            <h5 class="mx-1  pb-3 justify-content-start">
            <small><i class="fas fa-dot-circle text-sm"></i></small>  Status:<small>{caseDetail?.legacy_id}</small>
            </h5>
          </div>
          ...
          <div class="projects mb-4">
            <div class="projects-inner">
              <header class="projects-header ">
                ...
                <div class="count">| 32 Assets</div>
                <i class="zmdi zmdi-download pr-1"></i>
              </header>
              <table class="projects-table table-hover table-bordered">
                <thead> 
                  <tr>
                    ...
                    <th>Description</th>
                    <th>Location</th>
                    <th class=""><i class="fas fa-exclamation pl-1"></i>Actions</th>
                  </tr>
                </thead>
                {assets?.length > 0 ? (
                  assets.map((asset, index) => (
                    <tr>
                      ...
                      <td>
                        <p class="text-danger">{asset?.description}</p>
                      </td>
                      <td class="status">
